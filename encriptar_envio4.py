#!/usr/bin/env python3
"""
Script para encriptar envio4.png usando el mismo método que los archivos .bin
"""
...
def main():
    """Función principal"""
    archivo_entrada = "envio4.png"
    archivo_salida = "envio4.bin"
    
    # Verificar que el archivo de entrada existe
    if not os.path.exists(archivo_entrada):
        print(f"❌ Error: El archivo {archivo_entrada} no existe")
        print("💡 Asegúrate de que envio4.png esté en el mismo directorio que este script")
        return False
    ...
    if encriptar_archivo(archivo_entrada, archivo_salida):
        ...
        print("\n📋 Instrucciones:")
        print("1. Copia envio4.bin a la carpeta app/src/main/assets/")
        print("2. En el código Android, usa: desencriptarBin('envio4.bin')")
        print("3. O usa: establecerImagenDesencriptada(imageView, 'envio4.bin')")
        return True
    else:
