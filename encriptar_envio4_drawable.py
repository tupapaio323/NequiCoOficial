#!/usr/bin/env python3
"""
Script para encriptar envio4.png desde drawable y guardar el .bin en drawable
"""
import os
import sys
...
def main():
    ...
    archivo_salida = "app/src/main/res/drawable/envio4.bin"
    ...
    if encriptar_archivo(archivo_entrada, archivo_salida):
        ...
        print("\n📋 Ahora puedes:")
        print("1. Mover envio4.bin de drawable a assets")
        print("2. Usar en Android: desencriptarBin('envio4.bin')")
        print("3. Usar en Android: establecerImagenDesencriptada(imageView, 'envio4.bin')")
        return True
    else:
